...
param15="--num_epochs=3 --iter_name=bi_lstm_vocab50Small_retrGlove_ep3_redType1_h64 --train_embeddings=True --model_name=bi_lstm --reduction_dim_type=1 --hidden_nodes=64 --vocab_size=500"
...
param17="--num_epochs=2 --iter_name=bi_lstm_base_cleaned_text --train_embeddings=1 --model_name=bi_lstm --reduction_dim_type=3 --hidden_nodes=64 --cv_folds=4 --units_dense=64"
param18="--num_epochs=2 --iter_name=bi_lstm_base_maxlen72 --train_embeddings=1 --model_name=bi_lstm --reduction_dim_type=3 --hidden_nodes=64 --cv_folds=4 --units_dense=64 --callbacks_keras=2 --maxlen=72"
param19="--num_epochs=2 --iter_name=bi_lstm_base_maxlen72_noCV --train_embeddings=1 --model_name=bi_lstm --reduction_dim_type=3 --hidden_nodes=64 --cv_folds=0 --units_dense=64 --callbacks_keras=2 --maxlen=72"
#---
param21="--num_epochs=2 --iter_name=bi_lstm_base_atten_noCV --train_embeddings=1 --model_name=bi_lstm --reduction_dim_type=1 --hidden_nodes=64 --cv_folds=0 --units_dense=64 --callbacks_keras=2 --min_lr=0.0001"
param22="--num_epochs=3 --iter_name=bi_lstm_base_atten_noCV_3ep --train_embeddings=1 --model_name=bi_lstm --reduction_dim_type=1 --hidden_nodes=64 --cv_folds=0 --units_dense=64 --callbacks_keras=2 --min_lr=0.0001"
param23="--num_epochs=3 --iter_name=bi_lstm_base_atten_noCV_3ep_CLR --train_embeddings=1 --model_name=bi_lstm --reduction_dim_type=1 --hidden_nodes=64 --cv_folds=0 --units_dense=64 --callbacks_keras=1 --min_lr=0.001"

paramslist=("$param21" "$param22" "$param23")

for ((i = 0; i < ${#paramslist[@]}; i++)); do
  echo "$(date): CUDA_VISIBLE_DEVICES=1 python exec_all.py ${paramslist[$i]}"
  CUDA_VISIBLE_DEVICES=1 python exec_all.py ${paramslist[$i]}
done
